            ...
            <div class="col-sm-12">
                ...
                <form action="{{ url()->current() }}" method="get" class="search_form__form">
                    ...
                    <input
                        type="text"
                        name="search"
                        placeholder="{{ __( 'Быстрый поиск по новостям' ) }}"
                        class="form-control"
                                        ...
                                        <ul class="filter__check-list">
                                            ...
                                            @foreach( $categories as $cat )
                                                ...
                                                <li>
                                                    ...
                                                    <a href="{{ ($cat->id == $category->id) ? route('news') : route('news.category', $cat) }}" for="check-{{ $cat->id }}">
                    ...
                    <div class="sidebar__row-right">
                        ...
                        @if( $items->count() )
                            ...
                            <ul class="news__list column-3">
                                ...
                                @include( 'news.news-items', [ 'items' => $items ] )
