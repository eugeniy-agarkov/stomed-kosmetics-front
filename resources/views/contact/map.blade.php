                ...
                <div class="headpanel">
                    ...
                    <h2 class="headpanel__title">
                        @if( request()->routeIs('contact.clinic'))
                            {{ isset($seo->h1) ? $seo->h1 : $clinic->name }}
                        @else
                            {{ isset($seo->h1) ? $seo->h1 : __( 'Контакты' ) }}
                        @endif
                    </h2>
                    <!-- End Title -->
                    ...
                    <div class="headpanel__archive tab_mobile__content">
                        ...
                        @foreach( $clinics as $clinic )
                            ...
                            <a href="{{ route('contact.clinic', $clinic) }}" class="btn btn-opacity @if( request()->routeIs('contact.clinic')) @if( $clinic->id == app('request')->clinic->id ) active @endif @endif">
