                ...
                <div class="sidebar__row">
                                ...
                                <div class="filter__check">
                                    ...
                                    <ul class="filter__check-list">
                                        ...
                                        <li>
                                            ...
                                            <input type="checkbox" id="check-0" @if( !request()->clinic ) checked @endif >
                                            <a href="{{ route('doctor') }}" for="check-0">
                                        ...
                                        @foreach( $clinics as $item )
                                            ...
                                            <li>
                                                ...
                                                <input type="checkbox" id="check-{{ $item->id }}" @isset( request()->clinic ) @if( request()->clinic->id == $item->id ) checked @endif @endisset >
                                                <a href="{{ route('doctor.clinic', $item) }}" for="check-{{ $item->id }}">
                    ...
                    <div class="sidebar__row-right">
                        ...
                        @if( $items->count() )
                            ...
                            <!-- Services List -->
                            <ul class="doctors__grid">

                                @include( 'doctor.doctor-items', [ 'items' => $items ] )
