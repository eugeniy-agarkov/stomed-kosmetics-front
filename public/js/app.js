...
/* harmony import */ var _load_more__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./load.more */ "./resources/js/load.more.js");
...
jQuery(function ($) {
  ...
  var Forms = {
     ...
     * Form Appointment
     */
    formAppointment: function formAppointment() {}
  };
  Forms.init();
});
    ...
    install: function install() {
      ...
      $(document).on('click', '.loadMore', function (e) {
        ...
        $.ajax({
          ...
          success: function success(response) {
            $(target).append(response).ready(function () {// Code
            });
